...
* A Machine Screw Kit, Round Head Combo Drive (instructions pdf will have the exact contents needed.)

#### Printing Instructions

Everything needs to be in 100% infill, preferabally in ABS but was designed to also survive in PLA. See pdf instructions to refer to the testing section regarding performances of PLA lower. 

#### Author Notes
There is a support strut directly above the fire selector. It won't block the safety, but it will make it harder to manipulate under times and for speed shooting.
...
This is tested design that works and has been tested with 150rnds of .223 55g monarch. I cannot be responsible for personal injury or death, but the design was fired to ensure that it actually works.
