...
After far too long and a massive bout of data corruption across my entire hard drive, V3 of the Charon is finally ready. If you have any data issues with any file, please contact me via the #fosscad channel on irc.oftc.net or email me at shanrilivan@yahoo.com. Please include screenshots of the data issues or error messages. I have checked every file as thoroughly as I can with a limping system.

#### Changelog

* Modularization and choices (36 possible firearms)!
* Relief cut on grips to allow easier access to safety.
* All parts oriented for printing.
* Significant reduction of overhangs for easier printing.

#### General instructions

This release has been totally modularized. To create a firearm, you will need to select Magwell_3a or 3b, Buffer_Tube_1 or 2, Grip_1 or 2, and finally the Stock of your choice. The Unbuffered Pistol and Vanilla receiver are located in the Stocks folder and only have the options of Magwell_3a or 3b.
...
You will need to print 8 parts for each firearm receiver, with the logo panel being the ninth, (Excluding the Vanilla Receiver (5 parts) and Unbuffered Pistol (6 parts)) consisting of: Magwell (3 parts), Grip, Buffer Tube (2 Parts), Stock (2 parts).
...
#### Final Words
In this day and age, this project and these releases are more important to me than I can tell you. These files are open source. They are now yours. Chop them, hack them, twist them, make them yours. Only you can make exactly the firearm you want, and I've now given you a modular system to make it that much easier.
