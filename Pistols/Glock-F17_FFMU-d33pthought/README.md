...
This is a writeup for d33pthought's improvements to Free Men Don't Ask & Ivan's G17 model, which is patterned on the Glock G17 gen 3 frame. Included elements of this work:
  * git:
    ...
    * improved model file: [step](f17_d33p_ffmu.step) [stl](f17_d33p_ffmu.stl)
    * jig model: [step](jig_f17_rails.step) [stl](jig_f17_rails.stl)
    * [assembly guide](f17_assembly.md)
    * [public pgp keys](public_keys.pgp):
      * d33pthought:
    ...
    * [checksums for model files](checksums_sha512)
