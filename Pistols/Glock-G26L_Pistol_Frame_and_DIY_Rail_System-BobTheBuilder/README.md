# Glock G26L Pistol Frame and DIY Rail System
...
This is the G26L Pistol Frame and DIY Rail System by BobTheBuilder. This is NOT your normal Glock 26 frame. This is a custom G26 frame that uses a G26 locking block, G19 slide and DIY G17 rails. The system relies on a DIY G17 metal rail system which is added to a printed frame.

The Sc0rp file is a version of the frame by Sc0rp with some cosmetic differences, i.e., removing thumb spots on the frame. 


#### Instruction Videos
A set of instructional videos were made for FreeMenDontAsk's Glock 17 Gen 3 Pistol Frame and DIY Rail System. Below is a list of said videos. This G26L design is similar in construction and so the follow videos may be of use.
...
##### Required Parts
* Complete G26 frame internals
* Complete G19 slide
* DIY G17 Rails

#### The Rails
Reference the G17 Front and Rear Rail Drawings in the SpecSheets folder for the technical dimensions of the DIY rails. The rails use a roll pin and screws in the rear. Rails can me made in Aluminum, Steel, or Stainless Steel. 
