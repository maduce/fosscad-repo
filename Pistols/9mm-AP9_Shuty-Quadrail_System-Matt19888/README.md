...
This is a quad rail barrel shoud for the FOSSCAD Shuty AP-9. 

The Bi-Rail stl in no longer needed for this part. I left it in on case someone wants it. 
...
**Disclaimer:** Consider this part for educational purposes only until you do your own testing. Could also possibly be used as a barrel cooler by stuffing a wet rag in the end to keep the pla from over heating!

#### Changelog

* **Update 9/14:** Noticed and fixed an issue where I performed the boolean operation with the barrel retainer instead of the upper, I changed mounting locations during this process and forgot the upper had no fillets. My apologies for anyone that downloaded it. It wouldve still worked by rounding off the forward edges on the upper tho. I started doing this myself but decided to print another. 
