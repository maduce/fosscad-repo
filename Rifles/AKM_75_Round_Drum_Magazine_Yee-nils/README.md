...
7. Put the winder through the hole in the center of the rear body plate. Put the c-clamp around the notch in the winder.
8. Align the tabs on the rear body shell with the notches on the front body shell and join the two, making sure the winder is properly aligned with the key.
